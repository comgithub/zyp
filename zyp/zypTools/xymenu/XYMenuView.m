...
static const CGFloat kTriangleHeight = 6;//10

@interface XYMenuView()
{
    UIColor *kXYMenuContentBackColor;
    UIColor *kXYMenuContentLineColor;
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        kXYMenuContentBackColor = UIColor.whiteColor;
        UIColor *lineLightColor = [UIColor colorWithRed:232.0f/255.0f green:234.0f/255.0f blue:238.0f/255.0f alpha:1.0f];
        kXYMenuContentLineColor = UIColor.whiteColor;
    }
    return self;
}
...
//    [KColorAdjustDarkMode([UIColor colorWithRed:241.0f/255.0f green:242.0f/255.0f blue:247.0f/255.0f alpha:1.0f], UI_Cell_DarkMode_BG_Color) set];
    [bezierPath fill];
